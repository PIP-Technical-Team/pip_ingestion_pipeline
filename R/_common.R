...
# if (!require(future)) library(future)
# if (!require(future.apply)) library(future.apply)
# if (!require(future.callr)) library(future.callr)
...
#       workers = future::availableCores())) # get('PIP_N_WORKERS')
# }
# 
# close_workers <- function() {
